...
#define IRI_LAYER_BASIC 1
#define IRI_LAYER_FN    2
#define IRI_LAYER_XSFT  3
#define IRI_LAYER_XFN   4
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [IRI_LAYER_BASE] = LAYOUT_all(
        ...
        KC_LCTL, IRI_LFN, KC_LALT,                            KC_SPC,                             KC_RGUI, IRI_RFN, IRI_RFN, KC_LEFT, KC_DOWN, KC_RGHT),

    [IRI_LAYER_BASIC] = LAYOUT_all(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,          KC_VOLD, KC_MPLY, KC_VOLU,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,          KC_DEL,
        KC_GRV,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,                    KC_PGUP,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,                   KC_UP,
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             IRI_LFN, IRI_RFN, IRI_RFN, KC_LEFT, KC_DOWN, KC_RGHT),

    [IRI_LAYER_FN] = LAYOUT_all(
        KC_LSFT, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_F13,           RGB_VAD, KC_F15,  RGB_VAI,
        ...
        KC_BSPC, KC_DEL,  KC_INS,  KC_TRNS, KC_TRNS, KC_CAPS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS,  KC_DEL,  KC_BSPC,                   KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

    [IRI_LAYER_XSFT] = LAYOUT_all(
        IRI_SGR, IRI_S1,  IRI_S2,  IRI_S3,  IRI_S4,  IRI_S5,  IRI_S6,  IRI_S7,  IRI_S8,  IRI_S9,  IRI_S0,  IRI_SMN, IRI_SEQ, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS,
        ...
        KC_TRNS, IRI_SZ,  IRI_SX,  IRI_SC,  IRI_SV,  IRI_SB,  IRI_SN,  IRI_SM,  IRI_SCM, IRI_SPR, IRI_SSL, KC_TRNS,                   KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

    [IRI_LAYER_XFN] = LAYOUT_all(
        KC_TRNS, RGB_TOG, RGB_MOD, RGB_VAI, RGB_SPI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, UC_M_LN, UC_M_WI, UC_M_MA, RESET,   KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS,
        ...
        KC_TRNS, IRI_FZ,  IRI_FX,  IRI_FC,  IRI_FV,  IRI_FB,  IRI_FN,  IRI_FM,  IRI_FCM, IRI_FPR, IRI_FSL, KC_TRNS,                   KC_PGUP,
        KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                            KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_END),
};

static uint8_t        iri_encoder_state = 0;
static const keypos_t iri_encoder_pos[] = {{7, 4}, { 8, 4}};

void
matrix_scan_user(void) {
    if (iri_encoder_state == 0) {
        return;
    }
    keyevent_t evt = {
        .key     = iri_encoder_pos[iri_encoder_state - 1],
        .pressed = false,
        .time    = (timer_read() | 1)
    };
    iri_encoder_state = 0;
...
encoder_update_user(uint8_t index, bool clockwise) {
    keyevent_t evt = {
        .key     = iri_encoder_pos[clockwise],
        .pressed = true,
        .time    = (timer_read() | 1)
    };
    iri_encoder_state = clockwise + 1;
    action_exec(evt);
    return false;
};
